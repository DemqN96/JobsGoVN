const STATS = [
  { value: '15+', label: 'експертів з досвідом від 3 років' },
  { value: '8 років', label: 'офіційної роботи' },
  { value: '7680', label: 'влаштованих людей' },
  { value: '100%', label: 'офіційне та легальне працевлаштування' },
];
