        ...
        <div className="bg-white border border-gray-100 rounded-2xl shadow-sm p-7 mb-6">
          ...
          <div className="space-y-3 text-gray-600 leading-relaxed text-sm">
            ...
            <p>
              ...
              доглядом та логістикою</strong> у Нідерландах, Бельгії, Німеччині, Польщі, Чехії та інших країнах.
            </p>
            <p>
              За роки роботи ми надали супровід <strong>тисячам клієнтів — від першої консультації до
